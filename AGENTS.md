...
3. **Documentation** — AGENTS.md is the entry point (keep concise). Commands over prose. Update docs with code.
...
These apply to every artifact in this repo — code, docs, and AGENTS.md itself.
