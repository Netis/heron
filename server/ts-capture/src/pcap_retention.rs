...
use ts_common::config::PcapDumpRetentionConfig;
...
/// [`ts_storage::spawn_retention_task`]: returns immediately when retention
...
pub fn spawn_pcap_retention_task(
    ...
    tokio::spawn(async move {
        ...
        // turn into a CPU-burning sweep loop. Mirrors `ts_storage::spawn_retention_task`.
